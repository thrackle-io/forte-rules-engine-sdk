...
This is a Typescript based SDK for interacting with the Aqufi Rules Engine.

## Integating The SDK

An example application that integrates the Aquifi Rules SDK can be found at [Aquifi Rules SDK Integration Test](https://github.com/thrackle-io/aquifi-rules-sdk-integration-test)

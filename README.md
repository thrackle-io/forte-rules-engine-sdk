# forte-rules-sdk ** UNDER DEVELOPMENT **

This is a Typescript based SDK for interacting with the Forte Rules Engine.

## Integating The SDK

An example application that integrates the Rules SDK can be found at [SDK Integration Test](https://github.com/thrackle-io/forte-rules-sdk-integration-test)
...
```c
import { getRulesEngineContract, createFullPolicy, retrieveFullPolicy } from "../../forte-rules-sdk/src/index"
```
